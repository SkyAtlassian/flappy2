...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QLatin1String("Copyright &copy; YYYY Bitcoin Developers\n"
"Copyright &copy; YYYY FlappyCoin Developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About FlappyCoin", 0));
        label_3->setText(QApplication::translate("AboutDialog", "FlappyCoin v3.2", 0));
        label->setText(QApplication::translate("AboutDialog", "<html><head/><body><p><span style=\" font-weight:600;\">FlappyCoin </span>Core</p></body></html>", 0));
